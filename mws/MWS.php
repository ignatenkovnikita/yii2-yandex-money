...
namespace ignatenkovnikita\yandexmoney\mws;

use HttpException;
use ignatenkovnikita\yandexmoney\Log;
use ignatenkovnikita\yandexmoney\Utils;
...
class MWS {
    ...
    function __construct(\stdClass $settings) {
